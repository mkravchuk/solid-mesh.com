...
1. Select a theme from the [Themes](docsify-themeable--themes) section and replace the `<link>` in your `index.html`.
...
1. Review the [Options](docsify-themeable--options) section and configure as needed. For example:
...
1. Review the [Customization](docsify-themeable--customization) section and set theme properties as needed. For example:
