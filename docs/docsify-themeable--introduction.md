...
- **Flexible theme system based on CSS custom properties**<br>
  Theme settings are presented as a flat list of logically-named [CSS custom properties](docsify-themeable--customization). There's no need to navigate or modify complex CSS, allowing changes to be made quickly and confidently.

- **No packages to install or static files to build**<br>
  All processing is done in the browser, removing the need for CSS preprocessors and other build tools. Just link to a theme, then customize by setting [theme-related properties](docsify-themeable--customization). That's it.
...
- **Improved desktop and mobile experience**<br>
  ...
  - [Extensive customization](docsify-themeable--customization)
  - [PrismJS theme compatibility](docsify-themeable--customization#prismjs)
  - [Module scale typography](docsify-themeable--customization#base)
  - [Plugin customization](docsify-themeable--customization#plugin-styles)
  - [Ready transition](docsify-themeable--options#readytransition)
  - [Responsive tables](docsify-themeable--options#responsivetables)
